...
describe('datetime', () => {
  ...
  wrapTest(
    ...
    'ISO8601-ish YYYY-MM-DD hh:mm:ss - which does not parse into a Date instance'
  );
  wrapTest(
    [
      'Mon, 15 Jun 2009 20:45:30 GMT',
...
describe('case insensitive support', () => {
  wrapTest(
    ['A', 'b', 'C', 'd', 'E', 'f'],
    ['A', 'b', 'C', 'd', 'E', 'f'],
    'case insensitive pre-sorted array',
    { caseSensitive: false }
  );
  wrapTest(
    ['A', 'C', 'E', 'b', 'd', 'f'],
    ['A', 'b', 'C', 'd', 'E', 'f'],
    'case insensitive un-sorted array',
    { caseSensitive: false }
  );
  wrapTest(
    ['A', 'C', 'E', 'b', 'd', 'f'],
...
describe('rosetta code natural sort small test set', () => {
  ...
  wrapTest(
    ...
    'Equivalent accented characters (and case) (caseSensitive = false)',
    { caseSensitive: false }
  );
});
...
describe('descending support', () => {
  wrapTest(
    ['f', 'e', 'd', 'c', 'b', 'a'],
    ['f', 'e', 'd', 'c', 'b', 'a'],
    'descending pre-sorted array',
    { order: 'DESC' }
  );
  wrapTest(
    ['a', 'c', 'e', 'b', 'd', 'f'],
    ['f', 'e', 'd', 'c', 'b', 'a'],
    'descending un-sorted array',
    { order: 'DESC' }
  );
  wrapTest(
    ['a', 'c', 'e', 'b', 'd', 'f'],
...
describe('contributed tests', () => {
  ...
  wrapTest(
    ...
    'issue #5 - invalid sort order - Howie Schecter (caseSensitive = true)'
  );
  wrapTest(
  ...
  // strings are coerced as floats/ints if possible and sorted accordingly
  // e.g. they are not chunked
  // wrapTest(
  //   ['1.100', '1.1', '1.10', '1.54'],
  //   ['1.1', '1.10', '1.54', '1.100'],
  ...
  wrapTest(
    ...
    "issue #13 - ['v1.100', 'v1.10', 'v1.1', 'v1.54'] etc do not sort properly... - rubenstolk " +
    '(bypass float coercion)'
  );
  wrapTest(
    [
      'MySnmp 123456789123456789123456789123456789123456789123456789123456789123456789' +
      '1234567891234567891234567891234567891234567891234567891234567',
      'MySnmp 423456789123456789123456789123456789123456789123456789123456789123456789' +
      '1234567891234567891234567891234567891234567891234567891234567',
      'MySnmp 223456789123456789123456789123456789123456789123456789123456789123456789' +
      '1234567891234567891234567891234567891234567891234567891234567',
      'MySnmp 323456789123456789123456789123456789123456789123456789123456789123456789' +
      '1234567891234567891234567891234567891234567891234567891234567'
    ],
    [
      'MySnmp 123456789123456789123456789123456789123456789123456789123456789123456789' +
  ...
  wrapTest(
    ...
    ['SomeString', 'SomeString 1'],
    "PR #19 - ['SomeString', 'SomeString 1'] bombing on 'undefined is not an object' " +
    '- dannycochran'
  );
  wrapTest(
  ...
  wrapTest(
    ...
    "['2.2 sec','1.9 sec','1.53 sec'] - padded by spaces - harisb"
  );
  wrapTest(
    ['2.2sec', '1.9sec', '1.53sec'],
    ['1.53sec', '1.9sec', '2.2sec'],
    'https://github.com/overset/javascript-natural-sort/issues/13 - ' +
    "['2.2sec','1.9sec','1.53sec'] - no padding - harisb"
  );
});
